...
let myString = "My string literal"
//: ----
...
var myImmutableString = "aha!"
myImmutableString += " now"
//: ----
...
var myNewString = myImmutableString
myNewString += "bye"

print(myNewString)
print(myImmutableString)

func changeString(inout string:String) {
string += "bau"
}

changeString(&myImmutableString)
print(myImmutableString)
//: ----
...
for char in myImmutableString.characters {
    print(char)
}
//: ----
